...
X_train_np = np.fromfile(save_dir / "X_train.bin", dtype=np.float32).reshape(60000, 784)
y_train_np = np.fromfile(save_dir / "y_train.bin", dtype=np.int32)
X_test_np = np.fromfile(save_dir / "X_test.bin", dtype=np.float32).reshape(10000, 784)
y_test_np = np.fromfile(save_dir / "y_test.bin", dtype=np.int32)
