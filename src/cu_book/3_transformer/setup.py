    ...
    ext_modules=[
        CUDAExtension(
            ...
            sources=[
                ...
                os.path.join(
                    setup_dir, "csrc", "training", "kernels", "elementwise.cu"
                ),
        ...
        CUDAExtension(
            ...
            sources=[
                ...
                os.path.join(
                    setup_dir, "csrc", "inference", "kernels", "matmul_fwd.cu"
                ),
                os.path.join(setup_dir, "csrc", "inference", "kernels", "gemv_fwd.cu"),
                os.path.join(
                    setup_dir, "csrc", "inference", "kernels", "elementwise_fwd.cu"
                ),
                os.path.join(
                    setup_dir, "csrc", "inference", "kernels", "activation_fwd.cu"
                ),
                os.path.join(
                    setup_dir, "csrc", "inference", "kernels", "softmax_fwd.cu"
                ),
                os.path.join(
                    setup_dir, "csrc", "inference", "kernels", "layernorm_fwd.cu"
                ),
