// practice: flash_attention_v3 version = warp_streaming
// TODO: One warp per row, per-key warp-reduced dot product for the score.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See ../../10_flash_attention_v3/01_warp_streaming.cu for the reference.
...
int main() {
    ...
    std::cout << "flash_attention_v3 [warp_streaming] practice PASS  q=" << kQueryCount
