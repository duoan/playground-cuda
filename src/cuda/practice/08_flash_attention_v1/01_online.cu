// practice: flash_attention_v1 version = online
// TODO: One thread per query row, online softmax, no shared memory staging.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See ../../08_flash_attention_v1/01_online.cu for the reference.
...
int main() {
    ...
    std::cout << "flash_attention_v1 [online] practice PASS  q=" << kQueryCount
