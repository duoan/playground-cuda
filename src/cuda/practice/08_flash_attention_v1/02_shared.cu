// practice: flash_attention_v1 version = shared
// TODO: One block per query row, K/V tiles staged in shared memory.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See ../../08_flash_attention_v1/02_shared.cu for the reference.
...
int main() {
    ...
    std::cout << "flash_attention_v1 [shared] practice PASS  q=" << kQueryCount
