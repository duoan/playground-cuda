// practice: mlp version = fused
// TODO: Two kernels: fused_linear1_relu, then linear2.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See the reference in ../../06_mlp/02_fused.cu once you're done.
...
int main() {
    ...
    std::cout << "mlp [fused] practice PASS  batch=" << kBatch << " hidden=" << kHiddenDim << '\n';
