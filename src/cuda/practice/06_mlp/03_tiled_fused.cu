// practice: mlp version = tiled_fused
// TODO: One kernel: block-per-batch, stage input tile in smem, keep hidden in smem, do both matmuls.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See the reference in ../../06_mlp/03_tiled_fused.cu once you're done.
...
int main() {
    ...
    std::cout << "mlp [tiled_fused] practice PASS  batch=" << kBatch << " hidden=" << kHiddenDim << '\n';
