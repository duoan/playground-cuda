// practice: flash_attention_v2 version = tile_staged
// TODO: Block-cooperative K/V tile load, single-thread online softmax update.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See ../../09_flash_attention_v2/01_tile_staged.cu for the reference.
...
int main() {
    ...
    std::cout << "flash_attention_v2 [tile_staged] practice PASS  q=" << kQueryCount
