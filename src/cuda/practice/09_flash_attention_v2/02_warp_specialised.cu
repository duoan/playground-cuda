// practice: flash_attention_v2 version = warp_specialised
// TODO: One warp per row with distinct lane roles for load/score/state/accum.
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
// TODO: launch. See ../../09_flash_attention_v2/02_warp_specialised.cu for the reference.
...
int main() {
    ...
    std::cout << "flash_attention_v2 [warp_specialised] practice PASS  q=" << kQueryCount
