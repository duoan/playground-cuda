// practice: attention version = naive
// TODO: Three kernels: scores -> softmax (row-wise) -> value-mix.
#include <algorithm>
#include <cmath>
#include <cstdlib>
#include <iostream>
...
// TODO: launch. See ../../07_attention/01_naive.cu for the reference.
...
int main() {
    ...
    std::cout << "attention [naive] practice PASS  seq=" << kSeqLen << " head=" << kHeadDim << '\n';
    return EXIT_SUCCESS;
}
