// practice: vector_add version = naive
//
// Goal: fill in the kernel and launch. Everything else is boilerplate.
...
// TODO: naive kernel — one thread computes one output element.
...
// TODO: launch — grid = ceil(count / kThreadsPerBlock).
...
int main(int argc, char** argv) {
    ...
    std::cout << "vector_add [naive] practice PASS  count=" << count << '\n';
    return EXIT_SUCCESS;
}
