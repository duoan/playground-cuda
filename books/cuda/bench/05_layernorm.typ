...
table(
  ...
  [naive], [32], [0], [100.80], [0.0], [0.9], [1 / 83], [0.0],
  [block], [21], [2,048], [6.02], [0.6], [40.0], [12 / 1394], [0.6],
  [warp], [20], [72], [4.64], [0.8], [34.2], [17 / 1808], [0.8],
),
...
table(
  ...
  [naive], [32.0], [31.9], [0], [0.00], [27.48],
  [block], [32.0], [22.5], [0], [1.80], [3.67],
  [warp], [30.0], [27.4], [0], [4.99], [9.87],
),
